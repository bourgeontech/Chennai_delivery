package com.turtillion.estoredelivery.SingleMultipart;
...
public class VolleySingleton {
    private static com.turtillion.estoredelivery.SingleMultipart.VolleySingleton mInstance;
     ...
     */
    public static synchronized com.turtillion.estoredelivery.SingleMultipart.VolleySingleton getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new com.turtillion.estoredelivery.SingleMultipart.VolleySingleton(context);
        }
        return mInstance;
    }
